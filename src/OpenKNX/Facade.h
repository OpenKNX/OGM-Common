...
namespace OpenKNX
{
    ...
    class Facade
    {
      public:
        ...
        RGBLed progLed = RGBLed(&ledManager);
#ifdef INFO1_LED_PIN
        RGBLed info1Led = RGBLed(&ledManager);
        RGBLed& infoLed = info1Led;
#endif
#ifdef INFO2_LED_PIN
        RGBLed info2Led = RGBLed(&ledManager);
#endif
#ifdef INFO3_LED_PIN
        RGBLed info3Led = RGBLed(&ledManager);
#endif
